        ...
        <div className="md:row-start-2 lg:row-start-auto md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          <div>
            ...
            <p className="text-gray-500 text-base mt-2">
              I completed 10th and 12th from APS Mhow with a PCM stream and PE
              as an optional subject. It was a pretty good experience as I was
              part of the debate team and an editorial board member, and I went
              to different levels.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-500 text-base mt-2">
              I completed my college from LNCT, Indore. Most of my time was
              spent at home due to COVID, and thankfully attendance wasn't an
              issue. Overall, I graduated in 2024 with a pretty good experience
              from the CSE branch.
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-500 text-base mt-2">
              While learning different skills, I made quite a few projects—some
              silly, some ugly, and some were really exciting! <br />{" "}
          ...
          <div>
            ...
            <p className="text-gray-500 text-base mt-2">
              From different libraries to different frameworks, from different
              stacks to different projects, I have a lot to tell.{" "}
              <Link
                target=""
